...
- Evidence dashboard: [Command center runtime](evidence/cp2-streamlit-dashboard.png), [Reliability center](evidence/cp2-streamlit-reliability.png), [AI economics](evidence/cp2-streamlit-economics.png), [Request explorer](evidence/cp2-streamlit-explorer.png), [dashboard 6 nhóm chỉ số](evidence/cp2-dashboard-six-panels.png), [`docs/dashboard-spec.md`](../docs/dashboard-spec.md) và [`config/dashboard.yaml`](../config/dashboard.yaml)
