...
| ------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Nguyễn Đức Anh (`2A202601063`) | CP1 API & Middleware: hoàn thiện [`app/middleware.py`](https://github.com/DucAnhIT03/Day13-b3_HKT/blob/main/app/middleware.py), gán/propagate Correlation ID, response-time header và generic exception handler trong [`app/main.py`](https://github.com/DucAnhIT03/Day13-b3_HKT/blob/main/app/main.py).                                                                                      | [Integration commit `13bca82`](https://github.com/DucAnhIT03/Day13-b3_HKT/commit/13bca8203d0fa0d431ebdf6c0147f7e4530e2b6f) | `clear_contextvars()` ngăn request mới kế thừa context cũ; correlation ID phải xuất hiện cả response thành công lẫn lỗi để truy vết được toàn trình.                              |
| Nguyễn Huy Tỏa (`2A202601697`) | CP1 Security: bật scrub processor trong [`app/logging_config.py`](https://github.com/DucAnhIT03/Day13-b3_HKT/blob/main/app/logging_config.py), mở rộng regex email/phone/CCCD/thẻ/passport/địa chỉ tại [`app/pii.py`](https://github.com/DucAnhIT03/Day13-b3_HKT/blob/main/app/pii.py), kiểm chứng log không còn PII thô.                                                                     | [Integration commit `13bca82`](https://github.com/DucAnhIT03/Day13-b3_HKT/commit/13bca8203d0fa0d431ebdf6c0147f7e4530e2b6f) | PII cần được giảm thiểu từ đầu bằng hash/summarize và scrub lần cuối trước khi ghi file; regex địa chỉ phải xử lý cả chữ hoa/thường.                                              |
| Phan Văn Hiếu (`2A202601227`)  | CP1/CP2 Metrics & Dashboard: bổ sung `error_rate_pct` trong [`app/metrics.py`](https://github.com/DucAnhIT03/Day13-b3_HKT/blob/main/app/metrics.py), hoàn thiện [`docs/dashboard-spec.md`](https://github.com/DucAnhIT03/Day13-b3_HKT/blob/main/docs/dashboard-spec.md) và dashboard evidence đủ 6 nhóm chỉ số.                                                                               | [Integration commit `13bca82`](https://github.com/DucAnhIT03/Day13-b3_HKT/commit/13bca8203d0fa0d431ebdf6c0147f7e4530e2b6f) | Error rate phải dùng cả request thành công và thất bại làm mẫu số; dashboard cần cùng time range, đơn vị và SLO line để so sánh đúng incident.                                    |
| Tạ Long Khánh (`2A202601197`)  | CP2 SRE & Alerts: thiết lập [`config/slo.yaml`](https://github.com/DucAnhIT03/Day13-b3_HKT/blob/main/config/slo.yaml), ba symptom-based rules trong [`config/alert_rules.yaml`](https://github.com/DucAnhIT03/Day13-b3_HKT/blob/main/config/alert_rules.yaml) và runbook Metrics → Traces → Logs tại [`docs/alerts.md`](https://github.com/DucAnhIT03/Day13-b3_HKT/blob/main/docs/alerts.md). | [Integration commit `13bca82`](https://github.com/DucAnhIT03/Day13-b3_HKT/commit/13bca8203d0fa0d431ebdf6c0147f7e4530e2b6f) | Alert theo triệu chứng/SLO phản ánh tác động người dùng và ít nhiễu hơn alert phụ thuộc tên hàm hoặc implementation có thể thay đổi.                                              |
| Vũ Đăng Huy (`2A202601761`)    | CP2/CP3 QA & Investigation: chạy load test, instrument sub-spans RAG/LLM trong [`app/mock_rag.py`](https://github.com/DucAnhIT03/Day13-b3_HKT/blob/main/app/mock_rag.py) và [`app/mock_llm.py`](https://github.com/DucAnhIT03/Day13-b3_HKT/blob/main/app/mock_llm.py), điều tra official challenge `rag_slow`, tổng hợp evidence và báo cáo.                                                  | [Integration commit `13bca82`](https://github.com/DucAnhIT03/Day13-b3_HKT/commit/13bca8203d0fa0d431ebdf6c0147f7e4530e2b6f) | Metrics phát hiện latency spike, trace giúp khoanh vùng `retrieve`, log/correlation ID chứng minh hành trình request; blocking I/O trong async handler gây head-of-line blocking. |
